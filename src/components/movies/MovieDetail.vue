<template>
    <transition name="el-fade-in-linear">
        <el-row v-if="show">
                ...
                <el-col :span="24">
                    <div class="background__cover">
                        ...
                        <div class="movie__trailer" @click="playTrailer">
                            ...
                            <youtube class="yt__frame" v-show="trailerEnabled" @ready="ready" :video-id="movie.trailer"
                                     player-height="100%" player-width="100%" :player-vars="trailerOptions"
                                     @playing="animateTitle('playing')" @ended="animateTitle('stopped')"></youtube>
                        </div>
            ...
            <el-row :gutter="15">
                <el-col :xs="24" :sm="24" :md="{ 'span': 22, 'offset': 1 }" :lg="{ 'span': 22, 'offset': 1 }"
                        class="wrapper__details" :class="{'slide-down': downWrapper}">
                    <el-row :gutter="15">
                        <el-col :span="24">
                            <div class="main__desc">
                                <el-col :xs="24" :sm="24" :md="6" :lg="6">
                                    <div class="cover">
                                        ...
                                        <router-link class="edit__button" v-show="logged && role == 'admin'"
                                                     :to="`/movies/${movie._id}/edit`">
                                            <el-button class="chap-button" type="primary">Editer</el-button>
                                        </router-link>
                                        <a class="viewTrailer__mobile"
                    ...
                    <el-row>
                        <el-col :span="24">
                            <div class="related__movies" v-if="related.length">
                                ...
                                <el-row :gutter="20">
                                    <el-col :xs="12" :sm="12" :md="6" :lg="6" v-for="(movie, index) in related"
                                            :key="movie._id">
    ...
    methods: {
      getMovieReady(id) {
        ...
        this.$nextTick(() => {
          ...
          Services.movies.getMovie(id).then(res => {
            this.movie = res.data;
